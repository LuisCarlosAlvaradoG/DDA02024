...
# Output Format: Lista de tuplas (Name, Age) para cada fila filtrada.
# --------------------------------
def problem2(data, threshold):
    #Escribe aquí tu código
    # data: dict con "Name" y "Age"
    # threshold: entero
    # Debe retornar lista de tuplas (Name,Age) donde Age > threshold
    pass
...
# Output Format: Lista de tuplas (X, Y, Total) por fila.
# --------------------------------
def problem3(data):
    #Escribe aquí tu código
    # data: dict con "X" y "Y"
    # Debe retornar lista de tuplas (x, y, total)
    pass
...
# Output Format: Lista de tuplas (Category, Suma).
# --------------------------------
def problem4(data):
    #Escribe aquí tu código
    # data: dict con "Category" y "Value"
    # Debe retornar lista de tuplas (category, sum)
    pass
...
# Description:
# Dado dict con "Name" y "Score", retorna la tupla (Name,Score) de la fila con el Score máximo.
# Input Format: Dict con "Name" y "Score".
# Output Format: Tupla (Name,Score).
# --------------------------------
def problem5(data):
    #Escribe aquí tu código
    # data: dict con "Name" y "Score"
    # Debe retornar la tupla (name, score) con el máximo Score
    pass
...
# Description:
# Dado dict con "Product" y "Price", retorna lista de tuples ordenada por Price ascendente.
# Input Format: Dict con "Product" y "Price".
# Output Format: Lista de tuplas (Product,Price).
# --------------------------------
def problem6(data):
    #Escribe aquí tu código
    # data: dict con "Product" y "Price"
    # Debe retornar lista de tuplas ordenada por Price
    pass
...
# Description:
# Dado un dict con una columna "Color", retorna un dict de frecuencias de cada color.
# Input Format: Dict con clave "Color" -> lista de strings.
# Output Format: Dict literal con color:conteo.
# --------------------------------
def problem7(data):
    #Escribe aquí tu código
    # data: dict con "Color"
    # Debe retornar un dict {color:count}
    pass
...
# Description:
# Dado un dict con "ID" y "Value", retorna lista de tuplas de filas donde ID se repite.
# Input Format: Dict con "ID" y "Value".
# Output Format: Lista de tuplas (ID,Value) de filas duplicadas.
# --------------------------------
def problem8(data):
    #Escribe aquí tu código
    # data: dict con "ID" y "Value"
    # Debe retornar lista de tuplas de filas duplicadas
    pass
